...
// Initialize the assistant and expose it globally
let assistant;
window.addEventListener('DOMContentLoaded', () => {
    assistant = new MunicipalVoiceAssistant();
    // CRITICAL: Make assistant available globally for onclick handlers
    window.assistant = assistant;
});

// Settings Modal Functions
MunicipalVoiceAssistant.prototype.openSettings = function() {
    if (this.elements.settingsModal) {
        this.elements.settingsModal.style.display = 'flex';
    }
};

MunicipalVoiceAssistant.prototype.closeSettings = function() {
    if (this.elements.settingsModal) {
        this.elements.settingsModal.style.display = 'none';
    }
};
...
window.addEventListener('click', (e) => {
    ...
    if (e.target === modal && window.assistant) {
        window.assistant.closeSettings();
    }
});
